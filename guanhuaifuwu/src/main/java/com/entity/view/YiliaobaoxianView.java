...
public class YiliaobaoxianView extends YiliaobaoxianEntity implements Serializable {
	...
	public YiliaobaoxianView() {

	}

	public YiliaobaoxianView(YiliaobaoxianEntity yiliaobaoxianEntity) {
		try {
			BeanUtils.copyProperties(this, yiliaobaoxianEntity);
