...
public class ShequguanliyuanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShequguanliyuanEntity() {

	}

	public ShequguanliyuanEntity(T t) {
		try {
    ...
    public String toString() {
        return "Shequguanliyuan{" +
            "id=" + id +
            ", username=" + username +
            ", password=" + password +
            ", shequguanliyuanUuidNumber=" + shequguanliyuanUuidNumber +
            ", shequguanliyuanName=" + shequguanliyuanName +
            ", shequguanliyuanPhone=" + shequguanliyuanPhone +
            ", shequguanliyuanPhoto=" + shequguanliyuanPhoto +
            ", sexTypes=" + sexTypes +
            ", shequguanliyuanEmail=" + shequguanliyuanEmail +
